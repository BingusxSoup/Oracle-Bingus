            ...
            try {
              if (chatMode === 'portable') {
                ...
                try {
                  ...
                  // Vanilla Oracle Bingus (>=v0.12.x) ships a structured
              ...
              // Mid-run tool polling: vanilla Oracle Bingus currently does not
                ...
                },
                {
                  ...
                  async onEvent({ event, data }) {
                    ...
                    if (event === 'run.completed') {
                      ...
                      // Oracle Bingus currently does not stream tool.* events
