      ...
      if (data.capabilities?.chatCompletions) {
        ...
        setBackendMessage(
          data.capabilities.sessions
            ? 'Backend connected. Core chat works, and Oracle Bingus gateway enhancements are available.'
        ...
        >
          {step === 'welcome' && (
            <div className="space-y-4 text-center">
              ...
              />
              <h2 className="text-xl font-bold">Welcome to Bingus Labs</h2>
              <p className="text-sm" style={mutedStyle}>
                Works with any OpenAI-compatible backend. Oracle Bingus gateway APIs
          ...
          {step === 'connect' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Start by verifying that Bingus Labs can reach your
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p className="mt-2" style={mutedStyle}>
                      ...
                      <code>/v1/chat/completions</code>. If you point Oracle Bingus
                      Workspace at a Oracle Bingus gateway, enhanced features unlock
                      automatically.
                    </p>
                    <div
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-xs" style={mutedStyle}>
                {canEditConfig
                  ...
                  : 'This backend manages provider settings outside Bingus Labs. Confirm the model you expect to use, then test chat.'}
              </p>
              ...
              <div className="rounded-xl p-3 text-xs" style={cardStyle}>
                ...
                <p className="mt-1">
                  {backendInfo?.capabilities?.sessions
                    ? 'Oracle Bingus gateway detected'
          ...
          {step === 'test' && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                Verify that core chat works first. Enhanced Oracle Bingus features are
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm" style={mutedStyle}>
                ...
                {enhancedFeatures.length > 0
                  ? 'This backend also exposes Oracle Bingus gateway enhancements.'
                  : 'If you later connect a Oracle Bingus gateway, enhanced features unlock automatically.'}
              </p>
              <div
