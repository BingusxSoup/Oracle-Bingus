  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Bingus Labs, then sign in.',
    ...
    },
    {
      ...
      body: 'Bingus Labs can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
      ...
      action: (
        <div className="rounded-lg border border-primary-700 bg-primary-950 px-4 py-3 text-sm text-primary-200">
          Enhanced Oracle Bingus gateway APIs are optional. If core chat already works
    ...
    {
      title: 'Open Bingus Labs on your phone',
      body:
