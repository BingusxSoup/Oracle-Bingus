...
export const NPC_DIALOG: Record<string, NpcDialogTree> = {
  athena: {
    ...
    color: '#a78bfa',
    opening:
      'Welcome, builder. I am Athena. Oracle Bingus is the messenger layer for your work: one interface that routes prompts to the right model and tool, then carries the result back into your workflow.',
    lore: [
      'These Training Grounds teach the Hermes loop: move, equip, speak, remember, and build.',
      'Long before Bingus Labs, agents were tools. We invited them into a world instead.',
    ...
    choices: [
      ...
      {
        id: 'lore-hermes',
        label: 'Tell me about Oracle Bingus',
        reply:
  ...
  apollo: {
    ...
    lore: [
      ...
      'When Bingus Labs ships music generation in a quest, I am the one composing.',
    ],
    choices: [
      {
        id: 'song-fragment',
  ...
  chronos: {
    ...
    lore: [
      ...
      'The cron jobs in Bingus Labs are also mine. I run on heartbeat.',
    ],
    choices: [
      {
        id: 'oracle-riddle',
  ...
  artemis: {
    ...
    lore: [
      'When you run a long agent task in Bingus Labs, it walks somewhere. I find it when it forgets to come home.',
