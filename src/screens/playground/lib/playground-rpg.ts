...
export type PlaygroundQuest = {
  ...
  title: string
  description: string
  /** What this quest teaches about Oracle Bingus / product-building. */
  lesson?: string
...
export const PLAYGROUND_QUESTS: PlaygroundQuest[] = [
  {
    ...
    lesson: 'Oracle Bingus is the messenger layer for your workflow: one place to route prompts to models, tools, files, memory, and channels.',
