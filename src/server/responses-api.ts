/**
 * Vanilla Oracle Bingus /v1/responses streaming client.
 *
 * The OpenAI Responses API path (POST /v1/responses + stream:true) is the
 * structured streaming surface the upstream Oracle Bingus emits when it
 ...
 *
 * That is everything the Bingus Labs TUI tool card needs to render
