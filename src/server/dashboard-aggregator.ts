...
function normalizeSkillsUsage(
  ...
  // `summary` and `top_skills` per the Oracle Bingus confirmation.
...
function normalizeAnalytics(
  ...
  // Cost-coverage trust label. The Oracle Bingus confirmed that codex /
 ...
 * Per the Oracle Bingus guidance, computing this in the aggregator keeps
...
export type BuildOverviewExtraFetchers = {
   ...
   * pick up the canonical `active_agents` value the Oracle Bingus
